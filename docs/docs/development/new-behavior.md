...
- [Creating the Behavior](#creating-the-behavior)
  - [Creating the devicetree binding (`.yaml`)](#creating-the-devicetree-binding-yaml)
    - [`description`](#description)
    - [`compatible`](#compatible)
    - [`include`](#include)
    - [`properties` (Optional)](#properties-optional)
  - [Creating the driver (`.c`)](#creating-the-driver-c)
    - [`DT_DRV_COMPAT`](#dt_drv_compat)
    - [Dependencies](#dependencies)
      - [ZMK Event Manager](#zmk-event-manager)
    ...
    - [`DEVICE_DT_INST_DEFINE`](#device_dt_inst_define)
      ...
      - [Data Pointers (Optional)](#data-pointers-optional)
      - [Configuration Pointers (Optional)](#configuration-pointers-optional)
  - [Updating `app/CmakeLists.txt` to include the new driver](#updating-appcmakeliststxt-to-include-the-new-driver)
  - [Defining common use-cases for the behavior (`.dtsi`) (Optional)](#defining-common-use-cases-for-the-behavior-dtsi-optional)
- [Testing changes locally](#testing-changes-locally)
- [Documenting behavior functionality](#documenting-behavior-functionality)
